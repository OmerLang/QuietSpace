              ...
              <div className={`${styles.rateInfo} ${isFormOpen && styles.hideRatingsText}`}>
                <div className={styles.innerWrap}>
                  <div className={styles.rateWrapper}> <span>Quiet</span>
                    <div className={styles.scoreStar}><span className={styles.score}>{activePoi.noise_level_rating}</span><SingleStar rating={activePoi.noise_level_rating}/></div>
                  </div>    
                  <div className={styles.rateWrapper}> <span>Wifi</span>
                    <div className={styles.scoreStar}><span className={styles.score}>{activePoi.wifi_rating}</span><SingleStar rating={activePoi.wifi_rating}/></div>
                  </div>   
                  <div className={styles.rateWrapper}> <span>Seating Comfort</span>
                    <div className={styles.scoreStar}><span className={styles.score}>{activePoi.seating_comfort_rating}</span><SingleStar rating={activePoi.seating_comfort_rating}/></div>
                  </div>    
