  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.loginFormContainer}>
        <div
          className={`${styles.form} ${isLoginWelcomeOpen ? styles.formHide : ""}`}
        >
        ...
        <div
          className={`${styles.welcomeText} ${isLoginWelcomeOpen ? styles.welcomeTextShow : ""}`}
        >
          <h1>Welcome</h1> <span>{fname}</span>
        </div>
      </div>
    </div>
  );
