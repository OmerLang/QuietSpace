  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.signupFormContainer}>
        <div
          className={`${styles.form} ${isSignupWelcomeOpen ? styles.formHide : ""}`}
        >
          <div className={styles.signupTitle}>
            <h1>Signup</h1>
          </div>
          <SignupForm
            setIsSignupWelcomeOpen={setIsSignupWelcomeOpen}
          ></SignupForm>
        </div>
        <div
          className={`${styles.welcomeText} ${isSignupWelcomeOpen ? styles.welcomeTextShow : ""}`}
        >
